...
<div class="topnav">
  ...
  <%
      ...
      try{
          ...
          PreparedStatement ps = con.prepareStatement("select * from card where cardno=? and month=? and year=?");
          ps.setInt(1,card1);
          ps.setInt(2,month1);
          ps.setInt(3,year1);
          ...
          if(rs.next())
          {
              ...
              out.println("<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><h1 align='center'>Order sucessfull</h1>");
           
          }   
        else{
              
              out.println("<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><h1 align='center'>Incorrect card details</h1>");
