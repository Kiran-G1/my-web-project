...
<%
 String a;
 int c;
         String itemname =request.getParameter("dairy");
        try{
           ...
           // PreparedStatement ps = con.prepareStatement("select * from items where name like %"+itemname+" or %"+itemname+"or "+itemname+"%");
            ps.setString(1, itemname);
            out.println("<h1 align='center'><i>Your Search details</i></h1>");
            out.println("<html><body bgcolor='grey'><center><table border='3' cellpadding='12' cellspacing='1'>");
            out.println("<p align='center'><tr><th>Name</th><th>Quantity</th></tr>");
